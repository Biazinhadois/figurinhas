...
if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $file)) {
    $fotoUrl = $file;
    update($pdo, 'photocards', ['capa' => $fotoUrl], 
    "id = $idPhotocardsNovo");
    echo "Livro inserido com sucesso! ID: $idPhotocardsNovo";
    echo "<a href='CRUD/select.php? id=$idPhotocardsNovo'>Ver Photocard</a>";
} else {
